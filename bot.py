...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton("🎮 Играть", web_app=WebAppInfo(url="https://snusfnf-png.github.io/cardrop/"), color="primary")],
        [InlineKeyboardButton("Наш чат", url="https://t.me/chatcarzdrop", color="danger"),
         InlineKeyboardButton("Наш канал", url="https://t.me/carzdrop", color="danger")],
        [InlineKeyboardButton("➕ Добавить бота в чат", callback_data="add_to_chat", color="success")],
    ]
...
async def add_to_chat_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [[InlineKeyboardButton("➕ Добавить бота", url=f"https://t.me/{bot_username}?startgroup=start", color="success")]]
