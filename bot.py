...
def main():
    ...
    if WEBHOOK_URL:
        # ── Webhook режим: PTB встроенный webhook + aiohttp middleware ──
        import signal
        import json as _json
        from telegram import Update as _Update

        async def run_all():
            # 1. Сначала поднимаем aiohttp — Railway ждёт порт НЕМЕДЛЕННО
            ...
            print(f"Webhook установлен: {WEBHOOK_URL}/{BOT_TOKEN[:8]}...")
