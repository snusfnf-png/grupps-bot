...
def make_random_plate(country: str, forced_regions: list = None) -> tuple[bytes, str]:
    if country == "RU":
        if forced_regions:
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("Наш чат", url="https://t.me/chatcarzdrop", api_kwargs={"style": "danger"}),
...
async def settings_frame_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    frame_label = "Без улучшений" if frame == "none" else frame
    keyboard = [
...
async def handle_nz(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        img_bytes, chars = make_random_plate(country, forced_regions)
